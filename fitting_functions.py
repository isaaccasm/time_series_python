...
def fit_model(data, orders, metric, s=None, min_p=0.01, return_untrained_model=False, show=0):
    """
    ...
    :param show: int -> 0 do not show anything, 1 show one line with a summary, 2-> Show all the information
...
def fit_trend_splines(data, nsegs=2):
    ...
    return LSQUnivariateSpline(index, data, knots)
